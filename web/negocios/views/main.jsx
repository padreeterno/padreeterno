...
let params = new URLSearchParams(encodeURIComponent(location.origin)).toString();
// AJUSTES & DATA
		...
		return(
			<div className="R_r">
				...
				<div className="r_su987I abs flx _w">
					<Link to={{ pathname: "/negocios/loggin", search: "?retorna="+ params }}><button className="flx ccN" style={{background: "var(--fsrt-ble-)",color: "white"}}><ion-icon name="ios-key" role="img" class="hydrated" aria-label="key"></ion-icon><p style={{fontWeight : 700}}>Iniciar sesion</p></button></Link>
				</div>
			</div>
			)
	}
