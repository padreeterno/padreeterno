...
export default class Personal extends Component {
  ...
  registra(e) {
    ...
    axios.post("http://127.0.0.1:8000/api/negocios/registro/personal",{username,correo,password,cpassword,fullname,ci,academico,plan},{headers : { 'Content-Type' : 'application/json;charset=utf-8' }})
    .then(e => {
      var response = e.data;
      if(response.success){
        cookieCreate({
        ...
        <div className="rg98J">
          <form className="eM561 alct" onSubmit={this.registra}>
            <div className="flx one">
              <input ref={e => this.plan = e} type="hidden" name="plan" value="personal" />
              {/* Datos usuario*/}
              <div className="two">
