...
export default class Left extends Component{
    ...
    render(){
        return(
            <div style={this.props.posts && {marginBottom: "auto"}} className={this.props.posts ? "contenFieldPrincipal" : "contenFieldPrincipal flx ccN"}>
                {
                        ...
                        return(
                         <div key={key} className="OrPsRj45">
                            <div className="flx rUfLP0">
                             ...
                             <img className="rUfLP2" src={res.pic} alt={res.pic}/>
                             <div>
                                 <p>{res.text}</p>
                             </div>
                             {/* COMMENTS */}
